...
#
# Hôte: 127.0.0.1 (MySQL 8.0.33)
# Base de données: schema_chocolatte
# Temps de génération: 2024-11-22 12:39:06 +0000
# ************************************************************
...
CREATE TABLE `menu_pages` (
  ...
  KEY `menu_pages_section_id_sections_id` (`section_id`),
  ...
  CONSTRAINT `menu_pages_section_id_sections_id` FOREIGN KEY (`section_id`) REFERENCES `sections` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `product_categories` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `product_categories_parent_id_products_categories_id` (`parent_id`),
  CONSTRAINT `product_categories_parent_id_products_categories_id` FOREIGN KEY (`parent_id`) REFERENCES `product_categories` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_product_category_id_product_categories_id` (`product_category_id`),
  CONSTRAINT `product_product_category_id_product_categories_id` FOREIGN KEY (`product_category_id`) REFERENCES `product_categories` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sections` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`),
  KEY `section_page_id_pages_id` (`page_id`),
  CONSTRAINT `section_page_id_pages_id` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
